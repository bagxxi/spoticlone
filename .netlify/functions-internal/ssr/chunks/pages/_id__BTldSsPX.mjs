/* empty css                          */
import { c as createAstro, d as createComponent, r as renderTemplate, m as maybeRenderHead, e as addAttribute, f as renderSlot, g as renderComponent, h as renderHead, i as renderTransition } from '../astro_BC0ziSNQ.mjs';
import 'kleur/colors';
import 'html-escaper';
import cn from 'clsx';
...
}, "C:/Users/gabri/spotify-clone-astro/src/icons/Library.astro", void 0);
...
}, "C:/Users/gabri/spotify-clone-astro/src/icons/Home.astro", void 0);
...
}, "C:/Users/gabri/spotify-clone-astro/src/icons/Search.astro", void 0);
...
const $$SideMenuItem = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<li> <a class="flex gap-4 text-zinc-400 hover:text-zinc-items-center py-3 px-5 font-medium transition duration-300"${addAttribute(href, "href")}> ${renderSlot($$result, $$slots["default"])} </a> </li>`;
}, "C:/Users/gabri/spotify-clone-astro/src/components/SideMenuItem.astro", void 0);
...
const $$SideMenuCard = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<a${addAttribute(`/playlist/${id}`, "href")} class="playlist-item flex relative p-2 overflow-hidden items-center gap-5 rounded-md hover:bg-zinc-800"> <picture class="h-12 w-12 relative"> <img${addAttribute(cover, "src")}${addAttribute(`Cover of ${title} by ${artistsString}`, "alt")} class="w-full h-full object-cover rounded-md"> </picture> <div class="flex flex-auto flex-col truncate"> <h4 class="text-white text-sm"> ${title} </h4> <span class="text-xs text-gray-400"> ${artistsString} </span> </div> </a>`;
}, "C:/Users/gabri/spotify-clone-astro/src/components/SideMenuCard.astro", void 0);
...
}, "C:/Users/gabri/spotify-clone-astro/src/components/AsideMenu.astro", void 0);
...
}, "C:/Users/gabri/spotify-clone-astro/node_modules/astro/components/ViewTransitions.astro", void 0);
...
}, "C:/Users/gabri/spotify-clone-astro/src/layouts/Layout.astro", "self");
...
}, "C:/Users/gabri/spotify-clone-astro/src/icons/Time.astro", void 0);
...
}, "C:/Users/gabri/spotify-clone-astro/src/components/MusicsTable.astro", void 0);
...
const $$id = createComponent(async ($$result, $$props, $$slots) => {
  ...
  function calcularDuracionPlaylist(songs2, albumId) {
    let totalMinutos = 0;
    let totalSegundos = 0;
    const cancionesPlaylist = songs2.filter((cancion) => cancion.albumId === albumId);
...
}, "C:/Users/gabri/spotify-clone-astro/src/pages/playlist/[id].astro", "self");

const $$file = "C:/Users/gabri/spotify-clone-astro/src/pages/playlist/[id].astro";
