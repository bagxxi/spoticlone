/* empty css                          */
import { c as createAstro, d as createComponent, r as renderTemplate, m as maybeRenderHead, e as addAttribute, g as renderComponent, i as renderTransition } from '../astro_BC0ziSNQ.mjs';
import 'kleur/colors';
import 'html-escaper';
import { C as CardPlayButton, p as playlists, $ as $$Layout } from './_id__BTldSsPX.mjs';
...
const $$PlayListItemCard = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<article class="group relative hover:bg-zinc-800 shadow-lg hover:shadow-xl bg-zin-500/30 rounded-md transition-all duration-300"> <div${addAttribute(`absolute right-4 bottom-20 translate-y-4 transition-all duration-500 group-hover:translate-y-0 group-hover:opacity-100 opacity-0
...
}, "C:/Users/gabri/spotify-clone-astro/src/components/PlayListItemCard.astro", "self");
...
/* C:/Users/gabri/spotify-clone-astro/src/components/Greeting.svelte generated by Svelte v4.2.12 */
...
const Greeting = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	if (currentHour < 12 && currentHour > 5) {
		greeting = "Buen d\xEDa, viteh";
	} else if (currentHour > 12 && currentHour < 20) {
		greeting = "Buenas tardes, viteh";
	} else {
		greeting = "Buenas noches, viteh";
	}
...
}, "C:/Users/gabri/spotify-clone-astro/src/pages/index.astro", void 0);

const $$file = "C:/Users/gabri/spotify-clone-astro/src/pages/index.astro";
const $$url = "";
